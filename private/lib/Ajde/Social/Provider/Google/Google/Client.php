...
set_include_path(get_include_path() . PATH_SEPARATOR . $_SERVER['DOCUMENT_ROOT'] . str_replace('/index.php', '', $_SERVER['PHP_SELF']) . DIRECTORY_SEPARATOR . LIB_DIR . "Ajde" . DIRECTORY_SEPARATOR . "Social" . DIRECTORY_SEPARATOR . "Provider" . DIRECTORY_SEPARATOR . "Google" . DIRECTORY_SEPARATOR);
